...
CREATE TABLE IF NOT EXISTS "stores" (
	...
	"banner" varchar(500),
	"images" jsonb,
	"allow_online_orders" boolean DEFAULT false,
...
-- Create staff_permissions junction table
...
DO $$ BEGIN
 ALTER TABLE "stores" ADD CONSTRAINT "stores_category_id_store_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "store_categories"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "store_staff" ADD CONSTRAINT "store_staff_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "staff_permissions" ADD CONSTRAINT "staff_permissions_staff_id_store_staff_id_fk" FOREIGN KEY ("staff_id") REFERENCES "store_staff"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "staff_permissions" ADD CONSTRAINT "staff_permissions_permission_id_permissions_id_fk" FOREIGN KEY ("permission_id") REFERENCES "permissions"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
