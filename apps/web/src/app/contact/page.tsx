      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">{t.contact.emailSupport}</h3>
            <p className="text-gray-600 mb-4">{t.contact.emailSupportDescription}</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">{t.contact.phoneSupport}</h3>
            <p className="text-gray-600 mb-4">{t.contact.phoneSupportDescription}</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">{t.contact.visitUs}</h3>
            <p className="text-gray-600 mb-4">{t.contact.visitUsDescription}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="support">{t.contact.productSupport}</option>
                  <option value="billing">{t.contact.billingQuestion}</option>
                  <option value="partnership">{t.contact.partnershipOpportunity}</option>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">{t.contact.businessHours}</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">{t.contact.mondayFriday}</span>
                  <span className="font-semibold text-gray-900">{t.contact.supportHoursWeekday}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t.contact.saturday}</span>
                  <span className="font-semibold text-gray-900">{t.contact.supportHoursSaturday}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">{t.contact.sunday}</span>
                  <span className="font-semibold text-gray-900">{t.contact.supportHoursSunday}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">{t.contact.faq}</h3>
            ...
            {/* Response Time */}
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">{t.contact.responseTime}</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
                  <span className="text-gray-600">{t.contact.emailResponse}</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-blue-500 rounded-full mr-3"></div>
                  <span className="text-gray-600">{t.contact.phoneResponse}</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                  <span className="text-gray-600">{t.contact.liveChatResponse}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl shadow-xl p-12 border border-gray-100">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">{t.contact.readyToShop}</h2>
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
              {t.contact.readyToShopDescription}
            </p>
